...
function SalesInvoice() {
  return (
    <div className="container-fluid h-100"style={{ color:"#272B70",backgroundColor:"white" }} >
      <div className="row my-3  p-lg-5 p-md-2 p-sm-2" >
        ...
        <div className="col-lg-4 col-md-4 col-sm-4 col-4 pt-3 text-center ">
          <NavLink to="/SalesInvoice2" className= "btn-sm btn btn-outline-success rounded-4 border border-1">
        ...
        <div className="col-lg-12 col-md-12 col-md-12  col-xs-12 col-12 py-lg-4 py-md-4 py-sm-2 py-3 p-lg-5 p-md-5 p-sm-2 p-2">
          <div className="shadow p-lg-5 p-md-4 p-sm-4 p-1 rounded-3" style={{ backgroundColor: "white",color:"#9AA0A9" }}>
            <div className="row justify-content-around text-center text-lg-sm">
