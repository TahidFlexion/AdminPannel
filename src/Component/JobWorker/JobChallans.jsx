...
function JobChallans() {
  return (
    ...
    <div className="row p-lg-5 p-md-4 p-sm-4 p-1 my-3 " >
   <div className="col-lg-4 col-md-4 col-sm-4 col-4  saleshead" >
    <h3>Challans</h3>
   </div>
      ...
      <div className="col-lg-12 col-md-12 col-md-12 col-xs-12 col-12 px-lg-5 px-md-5 px-sm-1 px-1 ">
        <div className="shadow p-4 rounded-3 my-5" style={{color:"#9AA0A9", backgroundColor: "white" }}>
        ...
        <div className="shadow col-lg-12 col-md-12 col-md-12 p-4  rounded-3 my-3" style={{ backgroundColor: "white" }}>
          <div className="row justify-content-around text-center">
