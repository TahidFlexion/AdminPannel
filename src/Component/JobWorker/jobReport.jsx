...
function jobReport() {
  return (
    <div className="container-fluid h-100"style={{ color: "#272B70",backgroundColor:"white" }} >
      <div className="row p-lg-5 p-md-4 p-sm-4 p-1  my-2" >
        <div className="col-lg-6 col-md-6 col-sm-6 col-6 pt-3 ">
          <h3>job Outstanding report</h3>
        </div>
        <div className="col-lg-6 col-md-6 col-sm-6 col-6 pt-3 ">
          <input
            type="date"
        ...
        <div className="col-lg-12 col-md-12 col-md-12 col-12 ">
          ...
          <div className="shadow p-lg-5 p-md-4 p-sm-4 p-1  rounded-3 my-lg-5 my-md-3 my-sm-3 my-3" style={{ backgroundColor: "white" }}>
            <div className="row justify-content-around text-center">
