...
function Dashbord({ menushow, setMenushow }) {
  ...
  return (
    <>
      <div className={`dashbord-menu overflow-auto py-3 p-xxl-4 p-xl-4 p-lg-2 p-md-2 p-sm-2 p-2 col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-1  ${menushow && 'd-block h-100'}`} style={{ height: "90%", position: "fixed", bottom: "0px", left: "0px", backgroundColor: "white" }}>
        ...
        <div className="d-flex justify-content-between menu-item py-3" onClick={salesto}>
          <div
            className="d-flex" >
            <div className="dashbord-icon">
        ...
        <div className="d-flex justify-content-between menu-item py-3" onClick={purchaseto}>
          <div
        ...
        <div className="d-flex justify-content-between menu-item py-3" onClick={inventoryto}>
          <div
            className="d-flex  " >
            <div className="dashbord-icon">
