...
function Challans() {
  ...
  return (
    <div className="container-fluid h-100" style={{ color: "#272B70", backgroundColor: "white" }} >
      <div className="row my-lg-3 my-md-3 my-sm-3 my-2 p-lg-5 p-md-5 p-sm-3 p-2" >

        <div className="col-lg-9 col-md-6 col-sm-6 col-6 d-flex justify-content-start">
          <input
            type="date"
            className="form-control rounded-5 p-2 w-lg-50 w-md-100 w-sm-50 w-75" 
        ...
        <div className="col-lg-12 col-md-12 col-md-12 col-12">
          <div className="shadow p-lg-5 p-md-4 p-sm-4 p-1rounded-3 my-3 rounded-3 my-5" style={{ color: "#9AA0A9", backgroundColor: "white" }}>
          ...
          <div className="shadow p-lg-5 p-md-4 p-sm-4 p-1 rounded-3 " style={{ backgroundColor: "white" }}>
            <div className="row justify-content-around text-center">
          ...
          <div className="shadow  p-lg-5 p-md-4 p-sm-4 p-1rounded-3 my-3 " style={{ backgroundColor: "white" }}>
            <div className="row justify-content-around text-center">
              ...
              <div className="col">24ASEDSA8</div>
